...
class Paint(object):
    ...
    def __init__(self):
        ...
        self.setup()
        self.root.protocol("WM_DELETE_WINDOW", self.on_closing)  # Chamar a função 'on_closing' quando a janela for fechada
        self.root.mainloop()
    ...
    def on_closing(self):
        file_path = os.path.join(os.getcwd(), 'desenho.png')
